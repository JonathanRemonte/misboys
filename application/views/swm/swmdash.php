...
<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <?php if($_SESSION['urights']==8.4||$_SESSION['urights']=='8.5.1'||$_SESSION['urights']=='8.5.2'||$_SESSION['urights']=='8.5.3'||$_SESSION['urights']==1){ ?>
              ...
              document.addEventListener("DOMContentLoaded", () => {
                new Chart(document.querySelector('#pieChart'), {
                  ...
                  data: {
                    ...
                    labels: [ 'Composting Facilities/MRF', 'No Collection', 'RCA', 'SLF' ],
                    datasets: [{
              ...
              document.addEventListener("DOMContentLoaded", () => {
                new Chart(document.querySelector('#barChartSPP'), {
                  ...
                  data: {
                    ...
                    {
                      label: 'Composting Facilities/MRF',
                      data: [0, 5, 3, 13, 12],
                      backgroundColor: [
                        'rgba(75, 192, 192, 0.2)' ],
                      borderColor: [
