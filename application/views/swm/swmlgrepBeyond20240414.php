                ...
                <!-- card -->
                    <div class="row" style="padding-top:20px;">
                      ...
                      <table id="biotab" class="display" style="width:100%">
                        ...
                        <tbody>
                          <?php $repcnt=0; foreach ($reslgwas as $rowwas) {

                            // Jeff - ocmin and romblon, Sam - ormin and Marinduque, Sha - Palawan
                            ...
                            <tr>
                              ...
                              // ***************
                              // get first word
                              $words = explode(" ", $rowwas->lgu); $firstWord = $words[0];

                              if($_SESSION['urights']==8.4||$_SESSION['urights']==1){
                                // table for chief
                                ?>
                                  <td><?php echo $repcnt; ?></td>
                                  <td title="<?php echo $rowwas->lgnam; ?> | <?php $wasindat = new DateTime($rowwas->wasindat); echo $wasindat->format('YMd'); ?>"><?php echo $rowwas->lgu; ?></td>
                                  ...
                                  <td><?php if($rowwas->wasta==0){ ?>
                                      <a class="open-lguEvents" data-id="pndngvrfy" href="" data-bs-toggle="modal" data-bs-target="#pndngvrfy<?php echo $rowwas->wasid; ?>" id=""><span style="color:orange;"><i class="bi bi-hourglass-split" title="Click to Reply"></i></span></a>
                                    <?php }elseif($rowwas->wasta==1){ ?>
                                      <a class="open-lguEvents" data-id="rtrnrply" href="" data-bs-toggle="modal" data-bs-target="#wasrem<?php echo $rowwas->wasid; ?>" id=""><span style="color:orange;" title="<?php echo $rowwas->wasrem; ?>"><i class="bi bi-arrow-bar-left"></i></span></a>
                                      <!-- <a class="open-lguEvents" data-id="rtrnrply" href="" data-bs-toggle="modal" data-bs-target="#rtrnrply<?php echo $rowwas->wasid; ?>" id=""><span style="color:orange;" title="<?php echo $rowwas->wasrem; ?>"><i class="bi bi-arrow-bar-left"></i></span></a> -->
                                    <?php }elseif($rowwas->wasta==2){ ?>
                                        <a class="open-lguEvents" data-id="swmrtrnrply" href="" data-bs-toggle="modal" data-bs-target="#swmrtrnrply<?php echo $rowwas->wasid; ?>" id=""><span style="color:blue;" title="<?php echo $rowwas->wasrem; ?>"><i class="bi bi-arrow-bar-right"></i></span></a>
                                    <?php }

                                    elseif($rowwas->wasta==3){ ?>
                                        <span data-bs-toggle="modal" data-bs-target="#wasrem<?php echo $rowwas->wasid; ?>" style="color:green;" title="<?php echo $rowwas->wasrem; ?>"><i class="bi bi-check-circle-fill" title="Completed: <?php echo $rowwas->wasrem; ?>"></i></span>
                                    <?php } ?>

                                    <?php if($rowwas->wasta!=3){ ?>
                                      | <a class="open-lguEvents" data-id="drctaprv" href="" data-bs-toggle="modal" data-bs-target="#drctaprv<?php echo $rowwas->wasid; ?>" id=""><span style="color:green;"><i class="bi bi-bookmark-check" title="Click to Approve"></i></span></a>
                                    <?php }else{ } ?>
                                  </td>
                                <?php

                              }else if($_SESSION['urights']=='8.5.1'){
                                if($firstWord=='Palawan'){
                                  // table for Palawan
                                ?>
                                  <td><?php echo $repcnt; ?></td>
                                  <td title="<?php echo $rowwas->lgnam; ?> | <?php $wasindat = new DateTime($rowwas->wasindat); echo $wasindat->format('YMd'); ?>"><?php echo $rowwas->lgu; ?></td>
                              ...
                              }else if($_SESSION['urights']=='8.5.2'){
                                if($firstWord=='Oriental'||$firstWord=='Marinduque'){
                                  // table for Oriental Mindoro or Marinduque
                                ?>
                                  <td><?php echo $repcnt; ?></td>
                                  <td title="<?php echo $rowwas->lgnam; ?> | <?php $wasindat = new DateTime($rowwas->wasindat); echo $wasindat->format('YMd'); ?>"><?php echo $rowwas->lgu; ?></td>
                                  <td><?php $wasindat = new DateTime($rowwas->wasindat); echo $wasindat->format('YMd'); ?></td>
                              ...
                              }else if($_SESSION['urights']=='8.5.3'){
                                if($firstWord=='Occidental'||$firstWord=='Romblon'){
                                  // table for Occidental Mindoro or romblon
                                ?>
                                  <td><?php echo $repcnt; ?></td>
                                  <td title="<?php echo $rowwas->lgnam; ?> | <?php $wasindat = new DateTime($rowwas->wasindat); echo $wasindat->format('YMd'); ?>"><?php echo $rowwas->lgu; ?></td>
                                  <td><?php $wasindat = new DateTime($rowwas->wasindat); echo $wasindat->format('YMd'); ?></td>
                          ...
                          ?>
                              ...
                              <!-- drctaprv modal -->
                              <div class="modal fade" id="drctaprv<?php echo $rowwas->wasid; ?>" tabindex="-1" aria-hidden="true" style="display: none;">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                  <div class="modal-content">
                                    <div class="modal-header" style="background-color:#9b59b6;">
                                      <h5 class="modal-title" style="color:white;">Conversation</h5>
                                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
