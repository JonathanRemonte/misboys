                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      foreach ($lgacc as $rowlgacc) {
                        if($_SESSION['urights']=='8.5.3'){
                          $prov='Romblon';
                          $prov1 = explode(' ', trim($rowlgacc->lgu))[0];
                          if($prov1==$prov){ echo 'prov: '.$prov1; }else{  }
                        }

                          // echo '#$475475: '.$rowlgacc->lgu;
              ...
              <div class="card" style="background-color:#ccccff;">
                <div class="card-body">
                  ...
                  <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      <?php $lgucnt=0; foreach ($actlguser as $rowact) { $lgucnt++; ?>
                        <tr id="lgureg">
                          <th scope="row"><?php echo $lgucnt; ?></th>
