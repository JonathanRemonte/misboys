  ...
  <body>
    ...
    <aside id="sidebar" class="sidebar">
      ...
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " data-bs-target="#tables-nav" href="swmdash">
    ...
    <main id="main" class="main">
      <div class="pagetitle" style="">
        <h1>SWM Assessment/Monitoring</h1>
      </div>
      <section>
        <div class="card" >
          <div class="card-body">
            <div class="row" style="padding-left:13px;">
              <h5 class="card-title" style="font-weight:bold;"><a type="button" data-bs-toggle="modal" data-bs-target="#admodlgu">LGU</a></h5>
            </div>

            <!-- add div -->
            <!-- <div id="tow" style="padding-bottom:30px;">
                Add LGU here:
                <form class="" action="" method="">
                  <table>
                    <thead>
                      <tr>
                        <th> <input class="form-control" type="text" name="lguid" value="lguid"> </th>
                        <th> <input class="form-control" type="text" name="lgunam" value="lgunam"> </th>
                        <th> <button class="btn btn-outline-primary" type="submit" name="" id="btn_save">submit</button> </th>
                      </tr>
                    </thead>
                  </table>
                </form>
                    ...
                    <td><?php echo $row->scope; ?>
                      <?php if($row->scope!=''){ ?>
                        ...
                        foreach($resup as $rowup){ if($rowup->upterm=='year10'){ ?>
                          ...
                          <?php if($_SESSION['urights']==8.4 && $rowup->upterm=='year10' && $rowup->lguid==$row->lguid){ $lguatt++; ?>
                    ...
                    <td><?php echo $row->resno; ?>
                      <?php if($row->resno!=''){ ?>
                        ...
                        foreach($resup as $rowup){ if($rowup->upterm=='resno'){
                          //show and link of attachment
                          if($_SESSION['urights']==8.4 && $rowup->upterm=='resno' && $rowup->lguid==$row->lguid){ $lguatt++; ?>
                            <a href="<?php echo base_url().'upglobal/uplgu/'.$rowup->uplgufil; ?>" rel="nofollow" target="_blank">
                              <?php echo '<br/>'.$lguatt.') '.$rowup->uplgufil; ?>
                            </a>
                            <!-- unlink uplgu -->
