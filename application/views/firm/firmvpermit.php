  ...
  <body>
    ...
    <aside id="sidebar" class="sidebar">
      ...
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " data-bs-target="#tables-nav" href="firmdash">
            ...
            <table id="firmtab" class="display" style="width:100%">
              <thead>
                <tr>
                  ...
                  <td scope="col">PTO</td>
                  <td scope="col">WWDP</td>
                  <td scope="col">HWID</td>
                  <td scope="col">PTT</td>
                </tr>
              </thead>
              <tfoot style="display:table-header-group;"><tr><th></th>
                <th>Firm</th><th>ECC/CNC</th>
                <td scope="col">PTO</td><td scope="col">WWDP</td><td scope="col">HWID</td><td scope="col">PTT</td>
                </tr>
              </tfoot>
              <tbody>
                <?php
                ...
                foreach($result as $row) {?>
                  <tr>
                    <th scope="row" style="width:5%;"><a><?php echo $fcnt+=1; ?></a></th>
                    <th><a href="<?php echo site_url('Auth/firmprof'); ?>/<?php echo $row->fid; ?>" target="_blank" id="theman"><?php echo $row->firm; ?></a></th>
