    ...
    <main id="main" class="main">
      <div class="pagetitle" style="">
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-4">
              <a type="button" class="btn float-right" style="color:white;" data-bs-toggle="modal" data-bs-target="#adcoac"><h1>Accomplishments <?php echo '('.date('Y F').')'; ?></h1></a>
            </div>
          </div>
        </div>
      </div>
              ...
              <table id="tabcoac" class="display" style="width:100%">
                ...
                <tbody>
                  <?php $coacno=''; foreach ($plan as $rplan) {
                    ...
                    if($prov=substr($_SESSION['usec'], 5)==$rplan->pprov && $mon=date('Y-m')==$planmon=date("Y-m",$planmon)){
                      $coacno++; ?>
                      <tr>
                        <td><?php echo $coacno; ?>
                        </td>
