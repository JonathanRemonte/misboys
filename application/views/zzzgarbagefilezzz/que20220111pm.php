...
<body style="background-image: linear-gradient(to bottom right, #68BBE3, #9bd6ba);">
            ...
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <div class="row" style="padding-bottom:25px;">
                  ...
                  <div class="col-md-2">
                    <!-- spinner -->
                    <div class="card-body" style="text-align:center;background: #f5c5b8;">
                      <h1 class="card-title">ECC Sample</h1>
                      <!-- que -->
                          <h1 class="hqnum"><div id="ecccount"></div></h1>
                    </div>
                  </div>
                ...
                <div class="row" style="padding-bottom:25px;">
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="card-body" style="text-align:center;background: #c0ebc7;">
                      ...
                      <!-- que -->
                      <?php if($ptocnt==0){ ?><h1 class="hqnum" style="color:red;"><span id="ptocnt"><?php echo $ptocnt; ?></span></h1><?php }else if($ptocnt>=1){ ?>
                          <h1 class="hqnum"><a <?php if ($_SESSION['urights']==1||$_SESSION['urights']==7.4||$_SESSION['urights']==7.1||$_SESSION['urights']==6.1): ?> href="<?php echo site_url('Auth/edque') ?>/<?php echo $ptoid; ?>/<?php echo $_SESSION['uname']; ?>" <?php endif; ?> style="text-decoration:none;" id="ptocnt"><?php echo $ptocnt; ?></a></h1>
                      <?php } ?>
                    </div>
                  </div>
                ...
                <div class="row" style="padding-bottom:25px;">
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="card-body" style="text-align:center;background: #FFBFD9;">
                  ...
                  <div class="col-md-2">
                    <!-- spinner -->
                    <div class="card-body" style="text-align:center;background: #f5bfde;">
                      <h1 class="card-title" style="color:#f5bfde;">$$$</h1>
                ...
                <div class="row" style="padding-bottom:10px;">
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="card-body" style="text-align:center;background: #ABD9FC;">
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="card-body" style="text-align:center;background: #9AC8EB;">
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="card-body" style="text-align:center;background: #C7AF83;">
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="card-body" style="text-align:center;background: #C9A771;">
  ...
  <script type="text/javascript">
    ...
    function getnotif(){
      $.ajax({
        ...
        success:function(response){
          ...
          // if (obj.ptocnt==''||obj.ptocnt==0) { $('#ptocnt').html(obj.ptocnt).css('color', 'gray'); }else{ $('#ptocnt').html(obj.ptocnt).css('color', 'red'); }
    ...
    setInterval(function() {
      getnotif();
    },1000); //21 is after how much seconds you wanna reload!
