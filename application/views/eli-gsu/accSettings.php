    ...
    <div class="nesttabs">
        <div class="container">
            ...
            <?php if (!empty($profilePicture)) : ?>
                <img id="myImg" src="data:image/jpeg;base64,<?= base64_encode($profilePicture) ?>" id="output" width="200" />
            <?php else : ?>
                <!-- <img id="myImg" src="<?= base_url('assets/img/userdefault.png') ?>" style="width:100%;max-width:400px"> -->
                <img id="myImg" src="data:image/jpeg;base64,<?= base64_encode(isset($profilePicture) ? $profilePicture : '') ?>" id="output" width="200">
<p><?= isset($userData) ? $userData : "User data not found." ?></p>
<?= isset($profilePicture['profPic']) ? $profilePicture['profPic'] : '' ?>
...
<div id="myModal1" class="modal1">
    ...
    <form id="uploadForm" action="<?= site_url('Auth/uploadProfile') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <form method="post" action="<?php echo base_url('Auth/changePass1'); ?>">
                        ...
                        <!-- <div class="col-md-5 mx-auto">
                            ...
                            <div class="mt-5 text-center buttons">
                                <button class="btn btn-primary custom-btn" type="submit" name="save_password" value="Save Password">Update Password</button>
                                <a class="btn btn-danger" href="<?php echo base_url(); ?>index" type="button" value="Cancel">Cancel</a>
                            </div>
                        </div>
                    </form>
