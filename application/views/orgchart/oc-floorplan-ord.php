...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="assets/css/orgchart/oc-floorplan-ord.css" media="all">
...
<body>
  ...
  <a href="ojt-floorplan-list"><i id="left" class="fa-solid fa-chevron-left"></i></a>
  <a href="ojt-floorplan-fad"><i id="right" class="fa-solid fa-chevron-right"></i></a>
  ...
  <div class="content" id="content">
    <div class="container" id="container">
      ...
      <div class="modal-content" id="contentfloor" style="outline:none;border:none;box-shadow:none;background:none;" time-format="<?= $timezonefr ?>">
