...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="assets/css/orgchart/oc-floorplan-technical.css" media="all">
...
<body>
  ...
  <a href="ojt-floorplan-fad"><i id="left" class="fa-solid fa-chevron-left"></i></a>
  <a href="ojt-floorplan-records"><i id="right" class="fa-solid fa-chevron-right"></i></a>
            ...
            if($row['block'] == "noblock" && $row['primarywork'] == "1" &&
              ...
              <div id="yesblock" style="margin-bottom:1em;">
                <?php if($row['img'] == null || !$row['img']){?>
                  <img src="assets/img/userdefault.png" alt="" draggable="false">
                <?php } else { ?>
