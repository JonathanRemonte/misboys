...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/orgchart/oc-edit.css')?>" medial="all">
...
<script type="text/javascript" src="<?php echo base_url('assets/jsOJT/oc-editfooter.js');?>"></script>
</html>