...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="assets/css/orgchart/oc-landscapechart-v2.css" media="all">
...
<body>
  <div class="sidebar" id="sidebar">
    ...
    <a href="ojt-floorplan-list"><i class="fa-sharp fa-solid fa-map-location-dot"></i></a>
  ...
  <div class="morediv" style="margin-bottom:-10px;">
    <button id="v1" onclick="window.location.href='<?php echo site_url('ojt-landscape-chart'); ?>'">v1</button>
    ...
    <div class="container" id="container">
      <div id="prompt">
        ...
        <?php if($this->session->tempdata('post_edit')) :?>
          <?=   '<p id="alert-edit"><img src="img/check.gif" id="check">&nbsp;'.$this->session->tempdata('post_edit').'</p>'?>
        <?php endif;?>
      ...
      <div class="container-header">
        <div class="top-header">
          <img src="assets/img/denrlogo.png" alt="" id="headerimg" style="margin-right: 15px; margin-top:.5px;" draggable="false">
        ...
        <div class="level-1">
          <div class="inline" id="inline">
            <img src="data:image/jpeg;base64,<?php
                $blockemployee=
                file_get_contents
                ("https://slug.vercel.app/s/cdn-js-chart-main-layout");
  ...
  <script src="assets/jsOJT/oc-landscape-chart-v2.js"></script>
</body>
</html>