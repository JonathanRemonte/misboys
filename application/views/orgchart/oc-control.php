<?php $is_admin = $this->session->userdata('is_admin');
  if (!$is_admin || $is_admin == 2) { redirect("ojt-index"); } ?>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>OC Control</title>
    <link rel="stylesheet" type="text/css" href="assets/css/orgchart/oc-control.css" media="all">
...
<body>
    <div class="sidebar">
      ...
      <a href="ojt-landscape-chart"><i class="fa-solid fa-sitemap"></i></a>
    ...
    <div class="content">
      <div class="container">
        <div id="prompt">
          <?php if($this->session->tempdata('post_added')) :?>
            <?=   '<p id="alert-edit"><img src="assets/img/check.gif" id="check">&nbsp;'.$this->session->tempdata('post_added').'</p>'?>
          <?php endif;?>
        </div>
        ...
        <div class="top1">
          <form method="post" name="controlForm" enctype="multipart/form-data"  onsubmit="return checkFileSize();" action="Auth_Orgchart/insert_data"required>
  ...
  <script type="text/javascript" src="assets/jsOJT/oc-control.js"></script>
</body>
</html>
