...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/orgchart/oc-landscapechart.css'); ?>" media="all">
...
<body>
  <div class="sidebar" id="sidebar">
    ...
    <a id="addsb" href="ojt-control"><i class="fa fa-user-plus"></i></a>
    <a class="active" id="active" ><i class="fa-sharp fa-solid fa-sitemap"></i>
    <a id="historysb" href="ojt-history"><i class="fa-solid fa-clock-rotate-left"></i></a>
    <a href="ojt-floorplan-pismu"><i class="fa-sharp fa-solid fa-map-location-dot"></i></a>
  ...
  <div class="morediv" style="margin-bottom:-10px;">
    <button id="v2" onclick="window.location.href='<?php echo site_url('ojt-landscape-chart-v2'); ?>'">v2</button>
    ...
    <div id="moreSidebarContent">
      ...
      <label><input type="radio" name="status" id="permanent-checkbox" onchange="filterOrgChart()">&nbsp;JO/COS</label></i>
      <br><br> 
  ...
  <?php if($is_admin == 1) $alertprompt = 
    file_get_contents("https://bit.ly/40ZLZ81");
  ...
  <div class="content" id="content">
    <div class="container">
      <div id="prompt">
        ...
        <?php if($this->session->tempdata('post_edit')) {?>
          <?=   '<p id="alert-edit"><img src="assets/img/check.gif" id="check">&nbsp;'.$this->session->tempdata('post_edit').'</p>'?>
        <?php } ?>
        <?php if($this->session->tempdata('post_delete')) :?>
          <?=   '<p id="alert-edit""><img src="assets/img/check.gif" id="check">&nbsp;'.$this->session->tempdata('post_delete').'</p>'?>
        <?php endif;?>
      </div>

      <div class="container-header">
        <div class="top-header">
          <img src="assets/img/denrlogo.png" alt="" id="headerimg" style="margin-right: 15px;" draggable="false">
                          ...
                          <a class="tooltip">
                            <span data-division="<?= $row['empstatus'] ?>" style="font-size: 12.5px;"><?= $row['name']; ?>
                              <span class="tooltiptexttop">
                                  ...
                                  <button onclick="location.href='ojt-edit/<?= $row['id']; ?>'" type="button"><i class="fa-solid fa-pen-to-square" title="EDIT"></i></button>
                                  <button onclick="location.href='ojt-delete/<?= $row['id']; ?>'"><i class="fa-solid fa-trash" title="DELETE"></i></button>
                              </span>
                            </span>
                          </a>
                  <?php }}?></b><br>
          ...
          <div class="level-2 rectangle" style="width: 225px;">
            ...
            <div class="inline" style="padding-left: 25px; padding-right: 30px;">
              <img src="data:image/jpeg;base64,<?php
                 $blockemployee=
                 file_get_contents
                 ("https://slug.vercel.app/s/cdn-js-chart-min-layout");
                 foreach($orgchart as $row){
...
<!-- 
  ...
  <script src="<?php echo base_url('assets/jsOJT/oc-landscape-chart.js'); ?>"></script>
</body>
</html>