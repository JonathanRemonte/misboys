  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <!--?php if($_SESSION['urights']==3.3||$_SESSION['urights']==1){ ?-->
        <li class="nav-item">
          <a class="nav-link collapsed" title="For Records Use Only">
            <i class="bi bi-fingerprint"></i><span style="padding-right:10px;">Access Request</span>
          </a>
        </li>
      <!--?php } ?-->
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body" style="height:680px;">
              <h5 style="padding-top:8px;">WQMA</h5>
              ...
              <div class="embed-container">
                <iframe width="500" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" title="MIMAROPA MAP" src="https://www.arcgis.com/apps/Embed/index.html?webmap=6e33ae36234942209fc30ce7976620bf&extent=120.9108,13.2325,121.3156,13.4463&zoom=true&previewImage=
false&scale=true&disable_scroll=true&theme=light">
                </iframe>
              </div>
