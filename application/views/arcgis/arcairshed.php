    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="arcairshed" class="active">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body" style="height:680px;">
              <h5 style="padding-top:8px;">Airshed</h5>
              ...
              <div class="embed-container"><iframe width="500" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" title="SLF RD Jo" src="//www.arcgis.com/apps/Embed/index.html?webmap=6b3f6f0d9d5f489f9bcf921bb3885c93&extent=112.1152,6.6496,128.342,15.5979&zoom=true&previewImage=false&scale=true&disable_scroll=true&theme=light"></iframe></div>
