    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="arcelnidourgent" class="active">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="">
                <iframe width="100%" height="650" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" title="RD JO Consolidated (WQMA, Powerplant, Mining, SLF, Airshed)" src="https://www.arcgis.com/apps/Embed/index.html?webmap=36629f804dd54b72b0b16ab6783b43c5&extent=119.3449,11.2127,119.3519,11.2165&zoom=true&previewImage=false&scale=true&disable_scroll=true&theme=light"></iframe>
              </div>
